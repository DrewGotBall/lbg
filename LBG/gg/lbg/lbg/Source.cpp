...
void LBG(vector<vector<long double>>& universe, vector<vector<long double>>& regions) {
	...
	while (codebook <= 8) {    // Loop until the codebook size becomes 8.
		cout << "For CodeBook Size: " << codebook << endl;
		Ostream << "For CodeBook Size: " << codebook << endl;
		Lloyds_KMeans(universe, regions);    // Run K-Means for each iteration of LBG.
		cout << fixed << setprecision(6) << "CodeBook Generated By LBG Algorithm Round " << count << ":" << endl;
		Ostream << fixed << setprecision(6) << "CodeBook Generated By LBG Algorithm Round " << count << ":" << endl;
...
int _tmain(int argc, _TCHAR* argv[]) {
	...
	cout << fixed << setprecision(6) << endl << "Final CodeBook Generated By LBG Algorithm:" << endl;
	Ostream << fixed << setprecision(6) << endl << "Final CodeBook Generated By LBG Algorithm:" << endl;
	PrintMachine(regions);
	Ostream.close();
